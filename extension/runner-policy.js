((root,factory)=>{const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.ParrotRunnerPolicy=api;})(typeof globalThis!=='undefined'?globalThis:this,()=>{
 ...
 function autoArmDelayMs(target){if(!target||target.mode!=='response')return 0;return Math.max(0,Number(target.delaySec||0)*1000);}
 return Object.freeze({normalizeUrl,shouldArm,autoArmDelayMs});
});
