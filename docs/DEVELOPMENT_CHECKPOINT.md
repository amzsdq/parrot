...
- Route State Contract run `35986859199` for earlier live-evidence-digest release provenance completed SUCCESS. Duplicate-row hardening exact-head run `35992843454` also completed SUCCESS.
...
4. Continue adversarial checks of release evidence/builder boundaries where they add real fail-closed coverage; do not alter `extension/` unless a new candidate + fresh M6 is intended.
